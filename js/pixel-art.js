...
//Se elige un color de la rueda de color
colorPersonalizado.addEventListener('change', function () {
  // Se guarda el color de la rueda en colorActual
  colorActual = colorPersonalizado.value;
  // Completar para que cambie el indicador-de-color al colorActual
  indicadorDeColor.style.background = colorPersonalizado.value;
});
...
function crearPaleta(){
  ...
  for(var i = 0; i < nombreColores.length; i++){
    ...
    cuadroDeColor.className = "color-paleta";
...
function crearGrilla(){
  ...
  for(var i = 0; i < 1750; i++){
    ...
    pixel.style.backgroundColor = "while";
    ...
    pixel.addEventListener('mouseup', soltarMouse);
    //Al desplazarnos sobre los pixel detectamos si se debe pintar con trazo
...
//Variable en la que guardamos el color seleccionado de la paleta o rueda de colores
var indicadorDeColor = document.getElementById('indicador-de-color');

//Funcion global que permite cambiar el color de fondo de un objeto
...
$('#borrar').click(function(){
  $('#grilla-pixeles div').animate({'backgroundColor': 'White'}, 1100);
});

//Funcion para cargar los Superheroes
...
//Funcion para guardar el dibujo en archivo .png
